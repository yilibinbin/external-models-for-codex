...
export function readWorkspaceBoundPlanFile(inputPath, cwd = process.cwd(), env = process.env) {
  if (typeof inputPath !== "string" || !inputPath.trim()) {
    throw planReviewError("--plan requires a file path.", "PLAN_MISSING");
  }
  const workspaceReal = realpathIfPossible(canonicalWorkspaceRoot(cwd, env));
